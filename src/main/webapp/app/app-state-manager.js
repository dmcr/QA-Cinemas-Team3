    ...
    angular.module('cinemaApp').config(function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider.state("dashboard", {
       	...
       	templateUrl: "app/feature/seatType/update/update-seatTypes-partial.html"
            ...
            url: "/managescreens",
            templateUrl: "app/feature/screen/manage/manage-screen-partial.html"
        }).state("cms.managescreens.updatescreen", {
            url: "/updatescreen/{screenId:[0-9]*}",
            templateUrl: "app/feature/screen/update/update-screen-partial.html"
        }).state("cms.managescreens.newscreen", {
            url: "/newscreen",
            templateUrl: "app/feature/screen/add/add-screen-partial.html"

        }).state("cms.managefilms", {
            url: "/managefilms",
            templateUrl: "app/feature/film/manage/manage-film-partial.html"
        }).state("cms.managefilms.updatefilm", {
            url: "/updatefilm/{filmId:[0-9]*}",
            templateUrl: "app/feature/film/update/update-film-partial.html"
        }).state("cms.managefilms.newfilm", {
            url: "/newfilm",
            templateUrl: "app/feature/film/add/add-film-partial.html"

        }).state("cms.managebookings", {
            url: "/managebookings",
            templateUrl: "app/feature/booking/manage/manage-booking-partial.html"
        }).state("cms.managebookings.updatebooking", {
            url: "/updatebooking/{bookingId:[0-9]*}",
            templateUrl: "app/feature/booking/update/update-booking-partial.html"
            ...
            url: "/managetikcets",
            templateUrl: "app/feature/ticket/manage/manage-ticket-partial.html"
        }).state("cms.managetickets.updateticket", {
            url: "/updateticket/{ticketId:[0-9]*}",
            templateUrl: "app/feature/ticket/update/update-ticket-partial.html"
            ...
            url: "/booking/{filmId:[0-9]*}/{showingId:[0-9]*}",
